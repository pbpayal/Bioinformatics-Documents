...
write.table(sum(res$padj < 0.1, na.rm=TRUE),paste0(outputPrefix,"-results-summary-p-0.1.txt"), sep = "\t")
...
save_plot(paste0(outputPrefix, "-MAplot.png"),plotMA(dds, ylim=c(-5,5), main = outputPrefix))
...
pcaplot
save_plot(paste0(outputPrefix, "-PCA_plot.png"),pcaplot)
# Heatmap
library("pheatmap")
