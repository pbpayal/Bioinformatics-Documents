...
cd /data3/Payal/G176_Maria/Sorted_BAMS/
...
do
  ...
  REF_FLAT=/data3/Payal/Genomes/Mouse/refFlat_chr_rem.txt \
  STRAND_SPECIFICITY=FIRST_READ_TRANSCRIPTION_STRAND \
  RIBOSOMAL_INTERVALS=data3/Payal/Genomes/Mouse/intervalList.txt \
